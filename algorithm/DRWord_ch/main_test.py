...
tf.app.flags.DEFINE_string('test_data_path', '/home/wsw/workplace/deeplearning/DRWord/algorithm/test/', '')  
...
tf.app.flags.DEFINE_string('output_dir', 'outputs/', '') #ch4_test_outputs_20200115/
            ...
            for im_fn in im_fn_list:
                ...
                if input_roi_boxes is not None and input_roi_boxes.shape[0] != 0:
                    ...
                    if len(recog_decode_list) != input_roi_boxes.shape[0]:
                        ...
                        with open('/home/wsw/deeplearning/advancedFOTS/somepicwrong.txt', 'a') as f:
                            f.write('{}\r\n'.format(im_fn))
                        wrong_file_path = os.path.join('/home/wsw/deeplearning/advancedFOTS/picwrong/', os.path.basename(im_fn))
                    ...
                    with open(res_file_path, 'w') as f:
                        ...
                        for i, box in enumerate(input_roi_boxes):
                            ...
                            if True: 
                                ...
                                f.write('{},{},{},{},{},{},{},{},{}\r\n'.format(box[0, 0], box[0, 1], box[1, 0], box[1, 1], box[2, 0], box[2, 1], box[3, 0], box[3, 1], recognition_result)) 
                    ...
                    #for MTWI
                    res_file = os.path.join(FLAGS.output_dir, '{}.txt'.format(im_fn[:-4].split('/')[-1]))
