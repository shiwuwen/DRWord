...
def predictrctw(image_path, return_dic):
    checkpoint_path = '/home/wsw/workplace/deeplearning/DRWord/algorithm/DRWord_ch/checkpointrctw/'
    ...
    with tf.get_default_graph().as_default():
        ...
        with tf.Session(config=tf.ConfigProto(allow_soft_placement=True)) as sess:
            ...
            return_dic['im_result_rctw'] = im_result
            return_dic['txt_result_rctw'] = txt_result    
            #return im_result, txt_result

if __name__ == '__main__':
    im_result, txt_result = predictrctw('/home/wsw/workplace/deeplearning/DRWord/algorithm/test/img_55.jpg')
    print(txt_result)
