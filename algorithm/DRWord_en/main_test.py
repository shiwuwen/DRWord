...
tf.app.flags.DEFINE_string('test_data_path', '/home/wsw/temp/test1/', '')  
#/home/wsw/temp/ICDAR2015/ch4_test_images/ /home/wsw/temp/test1/
tf.app.flags.DEFINE_string('gpu_list', '-1', '')
tf.app.flags.DEFINE_string('checkpoint_path', 'checkpointsmtwi/', '') #pretrainedmodel/SynthText/
tf.app.flags.DEFINE_string('output_dir', 'output/', '') #ch4_test_outputs_20200115/
        ...
        with tf.Session(config=tf.ConfigProto(allow_soft_placement=True)) as sess:
            ...
            for im_fn in im_fn_list:
                ...
                if boxes is not None and boxes.shape[0] != 0:
                    ...
                    #res_file_path = os.path.join(FLAGS.output_dir, '{}.txt'.format(os.path.basename(im_fn).split('.')[0]))
